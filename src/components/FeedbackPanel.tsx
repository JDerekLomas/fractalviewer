...
export function FeedbackPanel({ population, generation, comment, onCommentChange }: FeedbackPanelProps) {
  ...
  const exportData = useMemo(() => {
    const lines: string[] = [];
    lines.push(`## Generation ${generation} Feedback`);
    lines.push('');
    ...
    // Add genome data for selected
    if (selected.length > 0) {
      lines.push('### Selected Genome Data:');
      lines.push('```json');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            placeholder="What patterns do you like? What should be different? Any general feedback..."
